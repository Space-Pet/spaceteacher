class ApiPath {
  ...
  static String getMenuInWeek =
      '/api.php?act=weeklymenu&type=json'; //              [TODO]
  ...
  static String getLeave = '$_apiV1/staff/leave-application/teacher';
  static String getDetailLeave = '$_apiV1/staff/leave-application/item';
}
