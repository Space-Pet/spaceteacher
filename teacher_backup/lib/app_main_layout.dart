...
import 'package:teacher/src/screens/attendance/view/attendance_navigator.dart';
...
class _AppMainLayoutState extends State<AppMainLayout> {
  ...
  List<Widget> widgetOptionKinderGarten(BuildContext context) {
    return [
      const HomeScreen(),
  ...
  List<Widget> widgetOptions(BuildContext context) {
    return [
      ...
      AttendanceNavigator(),
      const NotificationsScreen(),
      // const MenuScreen(userInfo: null,),
    ];
  }
          ...
          builder: (context, state) {
            return TabBarView(
              ...
              children: state.userInfo.isKinderGarten()
                  ? widgetOptionKinderGarten(context)
                  : widgetOptions(context),
            );
          },
        ),
