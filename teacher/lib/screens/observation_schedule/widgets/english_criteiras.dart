...
class EnglishCriterias extends StatefulWidget {
  const EnglishCriterias({
    super.key,
  ...
  @override
  State<EnglishCriterias> createState() => _EnglishCriteriasState();
}

class _EnglishCriteriasState extends State<EnglishCriterias> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      ...
                      children: [
                        if ((criteria.tieuChiNoiDungGiaoVien ?? '').isNotEmpty)
                          Text(
                            'Giáo viên/The Teacher: ${criteria.tieuChiNoiDungGiaoVien}',
                            style: AppTextStyles.semiBold16(
                              color: AppColors.brand600,
                            ),
                          ),
                        if ((criteria.tieuChiNoiDungHocSinh ?? '').isNotEmpty)
                          Padding(
                            padding: const EdgeInsets.only(top: 4.0),
                            child: Text(
                              'Các học sinh/All Students: ${criteria.tieuChiNoiDungHocSinh}',
                              style: AppTextStyles.semiBold16(
                                color: AppColors.brand600,
                              ),
                            ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Điểm chuẩn: ${criteria.tieuChiDiemMax}',
                                      style: AppTextStyles.semiBold14(
                                        color: AppColors.brand600,
                                      ),
                                    ),
