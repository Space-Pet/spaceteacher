...
class NotiCreateSelect extends StatefulWidget {
  ...
  @override
  State<NotiCreateSelect> createState() => _DropdownButtonComponentState();
}

class _DropdownButtonComponentState extends State<NotiCreateSelect> {
  ...
  @override
  didUpdateWidget(NotiCreateSelect oldWidget) {
