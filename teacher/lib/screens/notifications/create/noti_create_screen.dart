    ...
    return BlocProvider.value(
      ...
      child: BlocConsumer<NotiCreateBloc, NotiCreateState>(
        ...
        builder: (context, state) {
          ...
          final selectedFileW = List.generate(selectedFiles.length, (index) {
          ...
          final totalAttachments = selectedImages.length + selectedFiles.length;
            ...
            if (result != null) {
              if (result.files.length > 5) {
                ...
                if (tempFiles.isNotEmpty) {
                  context
                      .read<NotiCreateBloc>()
                      .add(NotiCreateSelectFiles(listFile: tempFiles));
                }
              }
            }
          }
