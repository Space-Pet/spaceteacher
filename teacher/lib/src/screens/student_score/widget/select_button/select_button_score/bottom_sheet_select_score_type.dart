...
class BottomSheetSelectScoreType extends StatefulWidget {
  const BottomSheetSelectScoreType({
    super.key,
  ...
  @override
  State<BottomSheetSelectScoreType> createState() =>
      _BottomSheetSelectScoreTypeState();
}

class _BottomSheetSelectScoreTypeState
    extends State<BottomSheetSelectScoreType> {
